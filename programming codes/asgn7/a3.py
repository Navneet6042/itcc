...
class Calculator:
    def __init__(self, r):
        ...
        self.result_display = Entry(r, width=20, justify='right', font=('Arial', 16))
        ...
        # create equal button
        equal_button = Button(r, text="=", width=20, height=2, command=self.calculate)
        equal_button.grid(row=5, column=0, columnspan=4, padx=5, pady=5)

    def create_button(self, label, row, col):
        button = Button(self.r, text=label, width=5, height=2, command=lambda: self.button_click(label))
